...
- **Online Medical Appointments**  
  View doctors, available time slots, and book appointments.

- **Doctor Listing**  
  Search doctors by specialty or name and view ratings.

- **Consultation Feedback**  
  Patients can write reviews and rate their experience.

- **Profile Management**  
  Includes Sign Up, Login, and user information forms.
